About xgcm-feedstock
====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/xgcm-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4400&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/xgcm-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `xgcm` can be installed with `conda`:
...
It is possible to list all of the versions of `xgcm` available on your platform with `conda`:
...
```
mamba search xgcm --channel conda-forge
```
...
mamba repoquery search xgcm --channel conda-forge

# List packages depending on `xgcm`:
mamba repoquery whoneeds xgcm --channel conda-forge

# List dependencies of `xgcm`:
mamba repoquery depends xgcm --channel conda-forge
```
